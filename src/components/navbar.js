    ...
    <nav className="bg-transparent">
      <div className="px-2 mx-auto font-mono max-w-7xl sm:px-6 lg:px-8">
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <p className="hidden px-4 text-sm text-white sm:block "> Welcome back, { state.user ? state.user.displayName : displayName} </p>
            <button className="p-1 text-gray-400 transition duration-150 ease-in-out border-2 border-transparent rounded-full hover:text-white focus:outline-none focus:text-white focus:bg-gray-700" onClick={() => console.log(state)}>
          ...
          --> */}
              <div className={(isOpen ? 'block' : 'hidden') + " origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg"}>
      ...
      <div className="hidden sm:hidden">
        <div className="px-2 pt-2 pb-3">
          <Link to="/" className="block px-3 py-2 text-base font-medium text-white transition duration-150 ease-in-out bg-gray-900 rounded-md focus:outline-none focus:text-white focus:bg-gray-700">Dashboard</Link>
          <Link to="/" className="block px-3 py-2 mt-1 text-base font-medium text-gray-300 transition duration-150 ease-in-out rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">Team</Link>
          <Link to="/" className="block px-3 py-2 mt-1 text-base font-medium text-gray-300 transition duration-150 ease-in-out rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">Projects</Link>
          <Link to="/" className="block px-3 py-2 mt-1 text-base font-medium text-gray-300 transition duration-150 ease-in-out rounded-md hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">Calendar</Link>
        </div>
      </div>
    </nav >
  );
