          ...
          <form className="flex flex-col items-center justify-between mb-10 sm:flex-row">
            ...
            <div className="mb-5">
              ...
              <input
                ...
                readOnly
                type="time"
                className="w-auto px-6 py-2 leading-tight text-center border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                name="lessonTime"
                value="13:30"
                id="lessonTime"
              />
            ...
            <div>
              <input
                required
                type="submit"
                className="w-auto px-6 py-2 leading-tight text-white transition duration-200 ease-in-out bg-gray-600 border-gray-600 rounded shadow appearance-none hover:opacity-75 focus:outline-none focus:shadow-outline"
                value="Submit"
              />
            </div>
          </form>
